...
const bcrypt = require('bcryptjs');
  ...
  MONGO_URL = "mongodb+srv://dbUser:web322@senecaweb.t5f1d.mongodb.net/web422?retryWrites=true&w=majority";
...
module.exports.connect = function () {
    return new Promise(function (resolve, reject) {
        let db = mongoose.createConnection(MONGO_URL, { useUnifiedTopology: true , useNewUrlParser: true } );
